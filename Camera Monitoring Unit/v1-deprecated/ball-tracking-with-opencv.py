...
os.system("python.exe delete-folder.py --path test-images --filetype folder")
time.sleep(1.0)
os.mkdir(os.getcwd()+"/test-images")
...
while True:
    ...
    fileName = os.getcwd() + "/test-images/image{}.jpeg".format(count)
    ...
    for i in range(1, len(pts)):
        ...
        if pts[i - 1] is None or pts[i] is None:
            continue
        # otherwise, compute the thickness of the line and draw the connecting linse
